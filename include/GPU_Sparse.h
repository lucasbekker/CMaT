class GPU_Sparse: private GPU_methods {
    public:
        ...
        GPU_Sparse ( matfile_load & mat_file, std::string variable ) {
            ...
            thrust::device_vector<double> V_temp(Size[2]);
            thrust::device_vector<int> i_temp(Size[2]);
            thrust::device_vector<int> j_temp(Size[0] + 1);

            // Prepare to insert the data into the Values vector.
            ...
            j_temp.insert(j_temp.begin(),j_p,(j_p + Size[0] + 1));
