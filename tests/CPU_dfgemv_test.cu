...
// $ MKL_ACT
// $ nvcc tests/CPU_dfgemv_test.cu -o tests/bin/CPU_dfgemv_test -O3 -L${MKLROOT}/lib/intel64 -lmkl_intel_lp64 -lmkl_tbb_thread -lmkl_core -ltbb -lstdc++ -lpthread -lm -ldl -lcublas -m64 -I${MKLROOT}/include
