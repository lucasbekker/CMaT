...
int main (  ) {
    ...
    r1 = A1.spdgemv(4,3,A1vp,A1ibp,A1iep,A1jp,b1p);
    r2 = A2.spdgemv(3,3,A2vp,A2ibp,A2iep,A2jp,b1p);
    r3 = A3.spdgemv(3,4,A3vp,A3ibp,A3iep,A3jp,b2p);
    ...
    // Print test result.
    if (pass == 1) {
        std::cout << "Test of CPU_methods.spdgemv() passed" << std::endl;
    } else {
        std::cout << "Test of CPU_methods.spdgemv() FAILED" << std::endl;
    }
